...
def load_shrek_1_srt() -> List[srt.Subtitle]:
    subs: List[srt.Subtitle]

    srt_path = str(pathlib.Path(__file__).parent.parent) + "/data/Shrek_1.srt"
...
def load_only_shrek_from_shrek_1_srt() -> List[srt.Subtitle]:
    subtitles = load_shrek_1_srt()
